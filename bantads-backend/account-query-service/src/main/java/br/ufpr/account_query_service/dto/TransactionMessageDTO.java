...
public class TransactionMessageDTO {
    ...
    public String getOrigemCpf() { return origemCpf; }
    public void setOrigemCpf(String origemCpf) { this.origemCpf = origemCpf; }
    public String getDestinoCpf() { return destinoCpf; }
    public void setDestinoCpf(String destinoCpf) { this.destinoCpf = destinoCpf; }
    public double getValor() { return valor; }
    public void setValor(double valor) { this.valor = valor; }
    public java.util.Date getDataHora() { return dataHora; }
    public void setDataHora(java.util.Date dataHora) { this.dataHora = dataHora; }
