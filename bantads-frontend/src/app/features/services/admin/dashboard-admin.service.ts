...
export class DashboardAdminService {
    ...
    getManagersWithClients(): Manager[] {
        ...
        managers.forEach((manager) => {
            manager.clients = clients.filter(
                (c) => c.manager && c.manager.id === manager.id
            );
        });
        ...
        if (!managersExisting) {
            const mockManagers: Manager[] = [
                // mock data for managers
                {
                    ...
                    name: 'Thalita Santos',
                    cpf: '596.644.780-24',
                    email: 'thalita@bantads.com',
                    telephone: '(41) 3361-4904',
                },
                {
                    id: '2',
                    name: 'Ana Carolina',
                ...
                {
                    id: '3',
                    name: 'Godofredo Pimentel',
                    cpf: '123.456.789-10',
                    email: 'godofredo@bantads.com',
                    telephone: '(41) 3361-4904',
                },
            ];
