      ...
      next: (address) => {
        if (address) {
          ...
          if (this.registerForm && this.registerForm.controls) {
            this.registerForm.controls['logradouro']?.setValue(address.logradouro);
            this.registerForm.controls['bairro']?.setValue(address.bairro);
            this.registerForm.controls['cidade']?.setValue(address.cidade);
            this.registerForm.controls['estado']?.setValue(address.estado);
            this.registerForm.controls['complemento']?.setValue(address.complemento || '');
          }
